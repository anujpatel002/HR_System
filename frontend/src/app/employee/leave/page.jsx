...
import { Calendar, ArrowLeft, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Apply for leave and track your applications</p>
              </div>
            </div>
            <button
